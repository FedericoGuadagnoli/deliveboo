        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="row align-items-center mb-3">
                    <div class="col-1">
                        <a href="{{ route('admin.dishes.index') }}"><i class="fa-solid fa-arrow-left fa-2x text-green"></i></a>
                    </div>
                    <div class="col-11">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="col-sm-12 col-lg-5">
                        <img src="{{ asset('storage/' . $dish->image) }}" alt="{{ $dish->slug }}" class="card-show">
                    </div>
                    <div class="col-sm-12 col-lg-7">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.dishes.destroy', $dish->id)}}" method="post" class="d-inline form-dish-delete">
                                @csrf
                                @method('DELETE')
